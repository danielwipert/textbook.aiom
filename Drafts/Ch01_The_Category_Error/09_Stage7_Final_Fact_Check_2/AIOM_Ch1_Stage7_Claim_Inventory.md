...
Generated from the live text by `build_factcheck_packet.py`, filed beside
this file. Stage 7 is structurally external: no source host is reachable
from the Claude environment, verified 2026-08-06 against six of them, so
nothing below is a verification. It is the material a checker needs.
